...
projectCatalog = [
  ...
  energy = [
    ...
    "<br>",
    "     -Cornerstone of engineering class project that I had to create to present at an expo at the end of the semester as have kids 7-11 playtest",
    "     -Created an online quiz hosted on a Flask server and would communicate via serial to a Raspberry Pi Pico in order to read button presses and send LED signals",
    "     -Received high praise from users for responsiveness, the site functionality, and educational potential",
    "<br>",
